...
<form action="" method="post" name="f_kategori" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-md-5">
    <input id="nama" name="nama" type="text" placeholder="Masukan Nama Kategori" value="<?php echo $v['nama'] ?>" class="form-control input-md text-uppercase" required="">
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
    <input id="kode" name="kode" type="text" placeholder="Contoh : BTK, FLN" value="<?php echo $v['kode'] ?>" class="form-control input-md text-uppercase" maxlength="3" required="">
